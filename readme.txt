=== CMS2CMS: Concrete5 to WordPress Migration  ===
...
* Speed - CMS2CMS takes up from 15 min to a couple of hours (depending on the size of a website) to complete the conversion.
...
1. Go to Admin -> Plugins, find “Concrete5 to WordPress Migration” and click Activate.
